  ...
  fetch('/register', {
    ...
    .then(function (responseJson) {
      if (!responseJson.success) {
        ...
        const succesCreateClient =
          document.getElementById('succesCreateClient');
...
function Compra_2() {
  document
    .getElementById('comprar_Cplusplus')
    .addEventListener('click', function () {
...
function Compra_3() {
  document
    .getElementById('comprar_htmlcss')
    .addEventListener('click', function () {
...
function Compra_5() {
  document
    .getElementById('comprar_asesoriapython')
    .addEventListener('click', function () {
...
function Compra_6() {
  document
    .getElementById('comprar_asesoriacpp')
    .addEventListener('click', function () {
...
function Compra_7() {
  document
    .getElementById('comprar_asesoriahtmlcss')
    .addEventListener('click', function () {
...
function Compra_8() {
  document
    .getElementById('comprar_asesoriamathcs')
    .addEventListener('click', function () {
